    ...
    return (
        <main className="min-h-screen w-full bg-gradient-to-b from-white via-green-50 to-green-100 pt-24 pb-16 flex flex-col">
            <section className="max-w-5xl mx-auto flex flex-col gap-16">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-lg text-green-900/90 leading-relaxed">
                            Depuis toujours, j’ai été attiré par l’aventure et la découverte de nouvelles cultures. Voyager pour moi, c’est s’ouvrir à l’inattendu, s’émerveiller devant la beauté du monde, et sortir de sa zone de confort pour mieux se découvrir soi-même. <br /><br />
                ...
                {/* 2. Le Vietnam, un déclic & des paysages à couper le souffle */}
                <div className="flex flex-col md:flex-row-reverse items-center gap-10">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-lg text-green-900/90 leading-relaxed">
                            Ce projet a véritablement pris forme lors de mon stage au Vietnam. Ce voyage m’a fait découvrir un tout autre monde, à travers ses cultures, ses habitants et ses paysages.<br /><br />
                            Cette expérience m’a appris à vivre au rythme d’une culture différente et à m’ouvrir encore plus au monde. <br /><br />
                            Si tu cherches de l’inspiration pour tes prochains voyages, j’espère que tu trouveras ici de quoi rêver… et surtout, de quoi passer à l’action !
                        </p>

                    </div>
                </div>

                {/* 3. Partager & donner envie de voyager */}
                <div className="flex flex-col md:flex-row items-center gap-10">
                    {/* Image à droite */}
                    <motion.div
                        className="w-full md:w-1/2 rounded-2xl overflow-hidden shadow-lg h-72 relative bg-green-50"
